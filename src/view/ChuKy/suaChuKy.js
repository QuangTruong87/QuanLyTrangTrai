...
export default function SuaChuKy({ route, navigation }) {
  ...
  const [soLuong, setSoLuong] = React.useState(newItem.soLuongNuoi);
  ...
  const handleDelete = async () => {
    try {
        const response = await fetch(`http://${ip}/API_QuanLyNongTrai/ChuKy/delData.php`, {
  ...
  const handleEdit = async () => {
    try {
        const response = await fetch(`http://${ip}/API_QuanLyNongTrai/ChuKy/editData.php`, {
        ...
        <View style={styles.thongTinDV}>
          ...
          <View style={styles.view_TT_DV}>
            ...
            <View>
              ...
              <Text style={styles.data_TT_DV}>
                {' '}
                Ngày nhận: {chonDongVat.ngayNhan}
              </Text>
              <Text style={styles.data_TT_DV}>
                {' '}
                Loại động vật: {chonDongVat.loaiDV}
              </Text>
              <Text style={styles.data_TT_DV}>
                {' '}
                Ghi chú: {chonDongVat.ghiChu} con
              </Text>
            </View>
          </View>
        </View>
