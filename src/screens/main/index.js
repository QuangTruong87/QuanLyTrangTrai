...
import PetListScreen from "../../screen/PetListScreen/index.tsx"
import AddPetScreen from "../../screen/AddPetScreen/index.tsx"
import PetDetailScreen from "../../screen/PetDetailScreen/index.tsx"
import { AuthProvider2 } from '../../Pet/PetContext';
import ChonAnhDongVat from "../../screen/AddPetScreen/ChonAnhDongVat"

import ManHinhDanhSachChuKyXemBenh from '../../view/XemBenh/dsChuKyXemBenh'
import XemGhiChepKhamBenh from '../../view/XemBenh/xemGhiChepKhamBenh'
import GhiChepKhamBenh from '../../view/XemBenh/ghiChepSucKhoe'
import SuaGhiChepKhamBenh from '../../view/XemBenh/suaGhiChepSucKhoe'
import ThongKeChiPhiKhamBenh from '../../view/XemBenh/thongKeChiPhiKhamBenh'
            ...
            <NavigationContainer>
                <Stack.Navigator screenOptions={{
                    ...
                    <Stack.Screen name="Màn hình thống kê tiền thu hoạch" component={ManHinhThongKeTienThuHoach} />
                     ...
                     <Stack.Screen name="Chọn ảnh động vật" component={ChonAnhDongVat} />

                    <Stack.Screen name="Danh sách khám bệnh" component={ManHinhDanhSachChuKyXemBenh} />
                    <Stack.Screen name="Xem ghi chép kiểm tra sức khỏe" component={XemGhiChepKhamBenh} />
                    <Stack.Screen name="Ghi lại kiểm tra sức khỏe" component={GhiChepKhamBenh} />
                    <Stack.Screen name="Sửa ghi chép kiểm tra sức khỏe" component={SuaGhiChepKhamBenh} />
                    <Stack.Screen name="Thống kê chi phí kiểm tra sức khỏe" component={ThongKeChiPhiKhamBenh} />
