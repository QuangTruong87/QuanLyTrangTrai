      ...
      <View style={styles.view_ds}>
        ...
        <View>
          <TouchableOpacity
            ...
            onPress={() =>
              navigation.navigate('Xem ghi chép kiểm tra sức khỏe', {
                itemCK: item,
              })
            }>
            <Text style={styles.btn_GhiChepChuKy}>Kiểm tra sức khỏe</Text>
          </TouchableOpacity>
        </View>

        <View>
          <TouchableOpacity style={styles.btn_ThuHoach} onPress={() =>
                                                                      navigation.navigate('Thống kê chi phí kiểm tra sức khỏe', {
                                                                        itemCK: item,
                                                                      })
                                                                    }>
            <Text style={styles.txt_ThuHoach}>Thống kê chi phí khám bệnh</Text>
          </TouchableOpacity>
        </View>
      </View>
