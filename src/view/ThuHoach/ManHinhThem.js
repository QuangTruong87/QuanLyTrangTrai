...
export default function ManHinhThem({ route, navigation }) {
  ...
  const handleSave = async () => {
      try {
              const response = await fetch(`http://${ip}/API_QuanLyNongTrai/ThuHoach/addData.php`, {
                method: 'POST',
                headers: {
             ...
             <View style={styles.khungTrong}>
                  ...
                  <View style={styles.chiaAnhVaThuocTinh}>
                       <View style={styles.anh}>
                          <Image
                           style={styles.front}
                           source={ chonChuKy.hinh ? {uri : chonChuKy.hinh} : require('../../image/dv_ck.png')}
                           />
                       </View>

                        <View style={styles.thuocTinh}>
                            <Text style={styles.title}>Tên động vật: {chonChuKy.tenDV}</Text>
                            <Text style={styles.title}>Loại động vật: {chonChuKy.loaiDV}</Text>
                            <Text style={styles.title}>
                                Ngày nhập hàng: {chonChuKy.ngayNhan}
                            </Text>
