...
export default function ManHinhSua({ route, navigation }) {
  ...
  const handleSave = async () => {
     try {
             const response = await fetch(`http://${ip}/API_QuanLyNongTrai/ThuHoach/editData.php`, {
  ...
  const handleDel = async () => {
     try {
             const response = await fetch(`http://${ip}/API_QuanLyNongTrai/ThuHoach/delData.php`, {
  ...
  const [thietHai, setThietHai] = React.useState(newItem.tienThietHai);
   ...
   const [soLuongNuoi, setSoLuongNuoi] = React.useState(newItem.soLuongNuoi);
    const [noiSanXuat, setNoiSanXuat] = React.useState(newItem.loaiDV);
   ...
   const [ngayNhapHang, setNgayNhapHang] = React.useState(newItem.ngayNhan);
   ...
   const [hinh, setHinh] = React.useState(newItem.hinh);
